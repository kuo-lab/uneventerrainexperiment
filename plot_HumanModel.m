...
for z = 1:length(conditions)
    ...
    speedConditionModel = modelData.speed.(conditions{z});
    timeConditionModel = modelData.time.(conditions{z});
    ...
    speedCondition = humanData.speed.(conditions{z});
    timeCondition = humanData.time.(conditions{z});  
